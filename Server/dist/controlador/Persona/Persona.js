...
const Persona_1 = __importDefault(require("../../modulos/Persona/Persona")); // Importación del modelo TipoDocumento
// Controlador para obtener todos los documentos
const gets = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const listPersona = yield Persona_1.default.findAll(); // Busca todos los documentos en la base de datos
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const servicio = yield Persona_1.default.findByPk(id); // Busca el documento por su ID
...
const Post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield Persona_1.default.create(body); // Crea un nuevo documento con los datos del cuerpo de la solicitud
        res.json({
...
const Update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.params; // Obtiene el ID del documento de los parámetros de la solicitud
    try {
        const product = yield Persona_1.default.findByPk(id); // Busca el documento por su ID
        if (product) {
