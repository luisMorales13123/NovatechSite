...
const TipodeDocumento_1 = __importDefault(require("../../modulos/TipodeDocumento/TipodeDocumento")); // Importación del modelo TipoDocumento
// Controlador para obtener todos los documentos
const gets = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const listProducts = yield TipodeDocumento_1.default.findAll(); // Busca todos los documentos en la base de datos
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield TipodeDocumento_1.default.findByPk(id); // Busca el documento por su ID
...
const Delete = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!product) {
        ...
        yield product.destroy(); // Elimina el documento de la base de datos
        res.json({
...
const Post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield TipodeDocumento_1.default.create(body); // Crea un nuevo documento con los datos del cuerpo de la solicitud
        res.json({
