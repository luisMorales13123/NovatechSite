...
const CargoTecnico_1 = __importDefault(require("../../modulos/CargoTecnico/CargoTecnico")); // Importación del modelo TipoCambio
// Controlador para obtener todos los documentos
const gets = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const listProducts = yield CargoTecnico_1.default.findAll(); // Busca todos los documentos en la base de datos
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield CargoTecnico_1.default.findByPk(id); // Busca el documento por su ID
...
const Post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield CargoTecnico_1.default.create(body); // Crea un nuevo documento con los datos del cuerpo de la solicitud
        res.json({
