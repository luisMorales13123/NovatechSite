...
const Equipo_1 = __importDefault(require("../../modulos/Equipo/Equipo"));
const gets = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const listProducts = yield Equipo_1.default.findAll();
    res.json(listProducts);
});
exports.gets = gets;
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const product = yield Equipo_1.default.findByPk(id);
    if (product) {
        res.json(product);
    }
    else {
...
const Post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    try {
        yield Equipo_1.default.create(body);
        res.json({
