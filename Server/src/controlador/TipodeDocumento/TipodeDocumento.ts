...
import TipoDocumento from '../../modulos/TipodeDocumento/TipodeDocumento'; // Importación del modelo TipoDocumento

// Controlador para obtener todos los documentos
export const gets = async (req: Request, res: Response) => {
    const listProducts = await TipoDocumento.findAll(); // Busca todos los documentos en la base de datos
...
export const get = async (req: Request, res: Response) => {
    ...
    const product = await TipoDocumento.findByPk(id); // Busca el documento por su ID
...
export const Post = async (req: Request, res: Response) => {
    ...
    try {
        await TipoDocumento.create(body); // Crea un nuevo documento con los datos del cuerpo de la solicitud
