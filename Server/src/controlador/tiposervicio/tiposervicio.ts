...
import tipóServicio from '../../modulos/tiposervicio/tiposervicio'; // Importación del modelo TipoDocumento

// Controlador para obtener todos los documentos
export const gets = async (req: Request, res: Response) => {
    const listServicios = await tipóServicio.findAll(); // Busca todos los documentos en la base de datos
...
export const get = async (req: Request, res: Response) => {
    ...
    const servicio = await tipóServicio.findByPk(id); // Busca el documento por su ID
...
export const Post = async (req: Request, res: Response) => {
    ...
    try {
        await tipóServicio.create(body); // Crea un nuevo documento con los datos del cuerpo de la solicitud
...
export const Update = async (req: Request, res: Response) => {
    ...
    try {
        const product = await tipóServicio.findByPk(id); // Busca el documento por su ID
